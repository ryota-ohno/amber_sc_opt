...
def init_process(args):
    ...
    for theta in theta_list:
        ...
        job_lines=[
                ...
                'hostname \n',
                '\n',
                f'python /home/ohno/Working/amber_sc_opt/BTBTB/src/step1_8_xyz_0.py --auto-dir {args.auto_dir}/{dir_name} --monomer-name {monomer_name} --num-nodes 30\n',
                '\n',
                '#sleep 5 \n'
                    ]
        job_lines1=[
                ...
                'hostname \n',
                '\n',
                f'python /home/ohno/Working/amber_sc_opt/BTBTB/src/step1_8_xyz_0.py --auto-dir {args.auto_dir}/{dir_name} --monomer-name {monomer_name} --num-nodes 20\n',
                '\n',
                '#sleep 5 \n'
                    ]
