...
def init_process(args):
    ...
    z_list=[np.round(z,1) for z in np.linspace(2.0,6.0,21)];i=0
    for z in z_list:
        dir_name = f'{z}'
        ...
        'hostname \n',
        '\n',
        f'python /home/ohno/Working/amber_sc_opt/BTBTB/src/step1_8_xyz.py --auto-dir {args.auto_dir}/{dir_name} --monomer-name {monomer_name} --num-nodes 5\n',
        '\n',
        '#sleep 12 \n'
            ]
        job_lines2=[
        ...
        'hostname \n',
        '\n',
        f'python /home/ohno/Working/amber_sc_opt/BTBTB/src/step1_8_xyz.py --auto-dir {args.auto_dir}/{dir_name} --monomer-name {monomer_name} --num-nodes 15\n',
        '\n',
        '#sleep 12 \n'
            ]
