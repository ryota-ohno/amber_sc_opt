...
def main_process(args):
    ...
    shutil.copy(f'/home/ohno/Working/amber_sc_opt/BTBTB/src/FF_calc.in',amber_path)
    shutil.copy(f'/home/ohno/Working/amber_sc_opt/BTBTB/monomer/{args.monomer_name}.frcmod',amber_path)
    ...
    mono_file=f'/home/ohno/Working/amber_sc_opt/BTBTB/monomer/{args.monomer_name}_mono.out'
