...
def main_process(args):
    auto_dir = f'/home/ohno/Working/amber_sc_opt/Cn/{args.auto_dir}'
    os.makedirs(auto_dir, exist_ok=True)
    os.makedirs(os.path.join(auto_dir,'amber'), exist_ok=True)
    os.makedirs(os.path.join(auto_dir,'gaussview'), exist_ok=True)
    amber_path=os.path.join(auto_dir,'amber')
    shutil.copy(f'/home/ohno/Working/amber_sc_opt/Cn/src/FF_calc.in',amber_path)
    shutil.copy(f'/home/ohno/Working/amber_sc_opt/Cn/monomer/{args.monomer_name}.frcmod',amber_path)
