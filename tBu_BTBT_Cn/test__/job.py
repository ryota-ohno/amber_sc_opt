...
def init_process(args):
    ...
    z_list=[np.round(z,1) for z in np.linspace(-3.8,4.0,40)]
    for z in z_list:
        dir_name = f'{z}'
        ...
        'hostname \n',
        '\n',
        f'python /home/ohno/Working/amber_sc_opt/tBu_BTBT_Cn/src/step1_8_xyz_0.py --auto-dir {args.auto_dir}/{dir_name} --monomer-name {monomer_name} --num-nodes 3\n',
        '\n',
        '#sleep 12 \n'
            ]
