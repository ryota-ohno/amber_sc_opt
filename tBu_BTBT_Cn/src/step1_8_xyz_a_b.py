...
def main_process(args):
    ...
    if not os.path.exists(auto_csv_path): 
        header = ['theta','A2','phi1','phi2','a','b','z','E','E1','E2','E3','E4','status']
    ...
    if not os.path.exists(auto_csv_path1):
        header = ['theta','A2','phi1','phi2','a','z','E1','status','file_name']
    ...
    if not os.path.exists(auto_csv_path2):
        header = ['theta','A2','phi1','phi2','b','z','E2','status','file_name']
    ...
    if not os.path.exists(auto_csv_path3):        
        header = ['theta','A2','phi1','phi2','a','b','z','E3','status','file_name']
    ...
    if not os.path.exists(auto_csv_path4):        
        header = ['theta','A2','phi1','phi2','a','b','z','E4','status','file_name']
    ...
    if not os.path.exists(auto_csv_path_mono):        
        header = ['phi1','phi2','Emono','status','file_name']
...
def listen(auto_dir,monomer_name,num_nodes,isTest):##args自体を引数に取るか中身をばらして取るかの違い
    ...
    if len(dict_matrix)!=0:#終わりがまだ見えないなら
        for i in range(len(dict_matrix)):
            ...
            params_dict3 = params_dict;params_dict4 = params_dict;params_dict_mono={k: v for k, v in params_dict.items() if (k in ['phi1','phi2'])}
