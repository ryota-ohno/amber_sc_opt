...
def main_process(args):
    ...
    shutil.copy(f'/home/ohno/Working/amber_sc_opt/ditBu_BTBT/src/FF_calc.in',amber_path)
    shutil.copy(f'/home/ohno/Working/amber_sc_opt/ditBu_BTBT/monomer/{args.monomer_name}.frcmod',amber_path)
